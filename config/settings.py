...
SECRET_KEY = env('DJANGO_SECRET_KEY', default='django-insecure-fallback-for-dev-only-change-before-deploy')
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='fazzpitchsidehubsupport@gmail.com')
